**Note:** This is a toy project I did to demonstrate a small glimpse of the OOP design and C++ skills I had learned in internships and university and had nothing to show for. It is not a useful application. I did use AI to speed up the code construction, but did not implement anything I don't understand well.
